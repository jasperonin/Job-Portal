...
<body>
    ...
    <div class="container w-25 mx-auto">
        ...
        <div class="mt-3">
            <form action="../action/applicant-register.php" method="post" class="form-group">
                ...
                <input type="text" name="phone" id="phone" pattern="[0-9]{4}-[0-9]{3}-[0-9]{4}" placeholder="09XX-XXX-XXXX" class="form-control">
